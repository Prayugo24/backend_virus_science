        		...
        		<div class="col-lg-8 col-md-7">
        			<div class="x_panel">
        				...
        				<div class="x_content">
        					...
        					<form method="post" action="<?=base_url();?>index.php/admin_Guru/save_password" class="form-horizontal">
        						<div class="error">
        						<?= validation_errors() ?>
        						<?= $this->session->flashdata('error') ?>
        					</div>
								<div class="form-group">
        							<label for="nama_user" class="label-control col-md-4">NIP</label>
        							<div class="col-md-8">
        								<input type="number" name="nip" value="" class="form-control"  autocomplete="off">
        							</div>
        						</div>

								<div class="form-group">
        							<label for="nama_user" class="label-control col-md-4">Nama</label>
        							<div class="col-md-8">
        								<input type="text" name="nama" value="" class="form-control"   autocomplete="off">
        							</div>
        						</div>
