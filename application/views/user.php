            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <button id="btnAdd" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah Pengguna</button>
                  <div class="x_content">
              ...
              <div class="modal-body">
                  ...
                  <form id="myForm" action="" method="post" class="form-horizontal" id="upload_file">
                    ...
                    <div class="form-group">
                      <label for="nama_user" class="label-control col-md-4">Nama Pengguna</label>
                      <div class="col-md-8">
  ...
  <script>
    $(function(){
        ...
        $('#btnAdd').click(function(){
            $('#myModal').modal('show');
            $('#myModal').find('.modal-title').text('Tambah Pengguna Baru');
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.success){
                            ...
                            $('.alert-success').html('Data Users Berhasil'+type+'').fadeIn().delay(4000).fadeOut('slow');
                            showAllUser();
                        }else{
                            alert('Error');
                        }
        ...
        $('#showdata').on('click', '.item-edit', function(){
            ...
            $('#editModal').find('.modal-title').text('Edit Data Pengguna');
